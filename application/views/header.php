    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url('beranda'); ?>" class="logo">
                ...
                <span class="logo-lg"><img src="<?php echo base_url('assets/images/logo.jpg'); ?>" width="27"
            ...
            <section class="sidebar">
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <?php
                        ...
                        if ($this->session->userdata('level') == 'kepaladesa') {
                                ?>
                <li><a href="<?php echo base_url('pejabat/tampil'); ?>"><i class="fa fa-address-card"></i>
                ...
                <?php
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo base_url('surat/pernikahan'); ?>"><i
                                        class="fa fa-envelope-o"></i> <span>Surat Status Pernikahan</span></a></li>
                            ...
                            <li><a href="<?php echo base_url('surat/pengantar_haji'); ?>"><i class="fa fa-envelope-o"></i>
                                    <span>SK Pengantar Ibadah Haji</span></a></li>
                ...
                <?php
                        ...
                        if ($this->session->userdata('level') == 'admin') {
                                ?>
                <li><a href="<?php echo base_url('pejabat/'); ?>"><i class="fa fa-address-card"></i>
                        <span>pejabat</span></a></li>
                <?php
                        }
                        if ($this->session->userdata('level') == 'admin') {
                                ?>
                <li><a href="<?php echo base_url('updatepassword/tampil'); ?>"><i class="fa fa-cog" aria-hidden="true"></i>
