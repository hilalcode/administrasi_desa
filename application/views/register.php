  ...
  <div class="limiter">
    <div class="container-login100">
      <div>
        ...
        <form class="login100-form validate-form"  action="<?php echo base_url('login/registrasi'); ?>" method="post" class="" role="form">
          <span class="login100-form-title p-b-26">
            SISTEM PENGELOLAAN DATA PENDUDUK <BR>DESA SALU INDUK
          </span>

          <span class="login100-form-title p-b-48">
            <img src="<?php echo base_url(); ?>/assets/images/logo.jpg"  width="150" height="150">
          </span>
          ...
          <?php } ?>
          <div class="wrap-input100 validate-input" data-validate = "Nama Petugas Tidak Boleh Kosong">
            <input class="input100" type="text" name="nama">
            <span class="focus-input100" data-placeholder="Nama Petugas"></span>
          </div>
          ...
          <div class="wrap-login100-form-btn">
            <div class="login100-form-bgbtn"></div>
              <a href="<?php echo base_url('login'); ?>" class="btn btn-lg btn-block btn-primary login100-form-btn" >
                Login
              </a>
            </div>
          </div>
