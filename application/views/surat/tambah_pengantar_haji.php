      ...
      <div class="box-header">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6">
              <div class="card">
                <h4 style="text-align:center"><b>TAMBAH SURAT KETERANGAN PENGANTAR HAJI</b></h4><hr>
              </div>
...
?>
              ...
              <form action="<?php echo base_url('surat/pengantar_haji/tambah'); ?>" method="post">
...
?>
                  ...
                  <div class="form-group">
                    <input type="submit" name="tambah_pengantar_haji" class="btn btn-success" value="Simpan">
