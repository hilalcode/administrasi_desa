                                ...
                                <form action="<?php echo base_url('surat/surat_kematian/tambah'); ?>" method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>NIK Mayit</label><a href="<?php echo base_url(); ?>penduduk/tambah/"
                                    ...
                                    <div class="form-group">
                                            <label>Jam Pemakaman</label>
                                            <div class="input-group">
                                                <input type="time" name="jam_pemakaman" id="pukul" class="form-control timepicker"
                                                    required>
                                                <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div>
