...
<br /><br /><br />
<font align="justify">
    Yang bertanda tangan dibawah ini , <?php echo $usaha->jabatan_pejabat; ?> Desa Saluinduk Kecamatan Bupon
...
<br>
<font align="justify">
    Menurut penelitian dan Pengantar RT setempat Nama/Orang tersebut benar Warga Desa Saluinduk Kecamatan Karawang Bupon Kabupaten Luwu, bahwa yang bersangkutan benar Membuka / Mempunyai Usaha
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Saluinduk, <?= date('d F Y', strtotime($usaha->tanggal_usaha)); ?></center>
        </td>
    </tr>
    <tr>
        <td>
