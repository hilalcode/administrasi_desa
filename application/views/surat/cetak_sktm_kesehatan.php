...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $sktm_kesehatan->jabatan_pejabat; ?> Desa Saluinduk Kecamatan
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Saluinduk, <?= date('d F Y', strtotime($sktm_kesehatan->tanggal_sktm_kesehatan)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
