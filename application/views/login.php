      ...
      <div>
        ...
        <form class="login100-form validate-form"  action="<?php echo base_url('login/auth'); ?>" method="post" class="" role="form">
          ...
          <?php if ($this->session->flashdata('pesan')) { ?>
            <div class="callout callout-danger">
              <p style="font-size:15px">
                <i class="fa fa-check-circle-o"></i> <?php echo $this->session->flashdata('pesan'); ?>
              </p>
            </div>
          <?php } ?>
          ...
          <div class="wrap-input100 validate-input" data-validate="Enter password">
        	...
        	<div class="form-group mb-3">
						...
						<!-- <select class="form-control" name="level">
							...
							<option value="3">Sekertaris Desa</option>
          ...
          <!-- <div class="wrap-login100-form-btn">
            <div class="login100-form-bgbtn"></div>
              <a href="<?php echo base_url('login/register'); ?>" class="btn btn-lg btn-block btn-primary login100-form-btn" >
                Register
              </a>
            </div>
          </div> -->
