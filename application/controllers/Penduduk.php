...
class Penduduk extends CI_Controller {
	...
	public function tampil() {
		$data['title'] = "Data Penduduk - Desa Salu Induk";
	...
	public function tambah() {
		$data['title'] = "Tambah Penduduk - Desa Salu Induk";
	...
	public function edit($nik) {
		$data['title'] = "Edit penduduk - Desa Salu Induk";
	...
	public function detail($nik) {
		...
		$data['title'] = "Detail penduduk - Desa Salu Induk";
		$this->load->model('m_penduduk');
